...
export class CashClosingService {
  ...
  async create(data: CreateCashClosingDto, userId?: number) {
    ...
    if (exist) throw new BadRequestException('Ya existe un cierre para este día.');
    ...
    const systemCash = (data.openingCash || 0) + cashSales + totalIncome - totalExpense - totalPayments;
